...
def _fused_sdp_choice(query: Tensor, key: Tensor, value: Tensor, attn_mask: Optional[Tensor]=None, dropout_p: _float=0.0, need_attn_weights: _bool=False, is_causal: _bool=False) -> _int: ...
...
def _lstm_mps(input: Tensor, hx: Union[Tuple[Tensor, ...], List[Tensor]], params: Union[Tuple[Tensor, ...], List[Tensor]], has_biases: _bool, num_layers: _int, dropout: _float, train: _bool, bidirectional: _bool, batch_first: _bool) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor]: ...
...
def _mps_max_pool2d(input: Tensor, kernel_size: Union[_int, _size], stride: Union[_int, _size]=(), padding: Union[_int, _size]=0, dilation: Union[_int, _size]=1, ceil_mode: _bool=False) -> Tensor: ...
@overload
...
def _scaled_dot_product_attention_math(query: Tensor, key: Tensor, value: Tensor, attn_mask: Optional[Tensor]=None, dropout_p: _float=0.0, need_attn_weights: _bool=False, is_causal: _bool=False) -> Tuple[Tensor, Tensor]: ...
...
def _scaled_dot_product_flash_attention(query: Tensor, key: Tensor, value: Tensor, dropout_p: _float=0.0, return_softmax: _bool=False, is_causal: _bool=False) -> Tuple[Tensor, Tensor, Tensor]: ...
...
def _sparse_bsc_tensor_unsafe(ccol_indices: Union[Tensor, List],row_indices: Union[Tensor, List], values: Union[Tensor, List], size: List[int], dtype: Optional[_dtype] = None, device: Optional[_device] = None, requires_grad: bool = False) -> Tensor: ...
def _sparse_bsr_tensor_unsafe(crow_indices: Union[Tensor, List],col_indices: Union[Tensor, List], values: Union[Tensor, List], size: List[int], dtype: Optional[_dtype] = None, device: Optional[_device] = None, requires_grad: bool = False) -> Tensor: ...
def _sparse_compressed_tensor_unsafe(comp_indices: Union[Tensor, List],plain_indices: Union[Tensor, List], values: Union[Tensor, List], size: List[int], dtype: Optional[_dtype] = None, layout: Optional[_layout] = None, device: Optional[_device] = None, requires_grad: bool = False) -> Tensor: ...
...
def _sparse_csc_tensor_unsafe(ccol_indices: Union[Tensor, List],row_indices: Union[Tensor, List], values: Union[Tensor, List], size: List[int], dtype: Optional[_dtype] = None, device: Optional[_device] = None, requires_grad: bool = False) -> Tensor: ...
...
def _test_autograd_multiple_dispatch_view_copy(input: Tensor) -> Tensor: ...
...
def ccol_indices_copy(input: Tensor) -> Tensor: ...
...
def row_indices_copy(input: Tensor) -> Tensor: ...
...
def sparse_bsc_tensor(ccol_indices: Union[Tensor, List],row_indices: Union[Tensor, List], values: Union[Tensor, List], size: Optional[_size]=None, *, dtype: Optional[_dtype]=None, device: Union[_device, str, None]=None, requires_grad:_bool=False) -> Tensor: ...
def sparse_bsr_tensor(crow_indices: Union[Tensor, List],col_indices: Union[Tensor, List], values: Union[Tensor, List], size: Optional[_size]=None, *, dtype: Optional[_dtype]=None, device: Union[_device, str, None]=None, requires_grad:_bool=False) -> Tensor: ...
def sparse_compressed_tensor(compressed_indices: Union[Tensor, List],plain_indices: Union[Tensor, List], values: Union[Tensor, List], size: Optional[_size]=None, *, dtype: Optional[_dtype]=None, layout: Optional[_layout] = None, device: Union[_device, str, None]=None, requires_grad:_bool=False) -> Tensor: ...
...
def sparse_csc_tensor(ccol_indices: Union[Tensor, List],row_indices: Union[Tensor, List], values: Union[Tensor, List], size: Optional[_size]=None, *, dtype: Optional[_dtype]=None, device: Union[_device, str, None]=None, requires_grad:_bool=False) -> Tensor: ...
...
def symeig(input: Tensor, eigenvectors: _bool=False, upper: _bool=True, *, out: Union[Tensor, Tuple[Tensor, ...], List[Tensor]]=None) -> torch.return_types.symeig: ...
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_convolution', '_convolution_mode', '_copy_from', '_copy_from_and_resize', '_ctc_loss',
 '_cudnn_ctc_loss', '_cudnn_init_dropout_state', '_cudnn_rnn', '_cudnn_rnn_flatten_weight',
 '_cufft_clear_plan_cache', '_cufft_get_plan_cache_max_size', '_cufft_get_plan_cache_size',
 '_cufft_set_plan_cache_max_size', '_cummax_helper', '_cummin_helper',
 ...
 '_foreach_neg', '_foreach_neg_', '_foreach_norm', '_foreach_reciprocal', '_foreach_reciprocal_',
 '_foreach_round', '_foreach_round_', '_foreach_sigmoid', '_foreach_sigmoid_', '_foreach_sin',
 ...
 '_fused_adam_', '_fused_dropout', '_fused_moving_avg_obs_fq_helper',
 '_fused_moving_avg_obs_fq_helper', '_fused_sdp_choice', '_fw_primal_copy',
 '_grid_sampler_2d_cpu_fallback', '_has_compatible_shallow_copy_type', '_histogramdd_bin_edges',
 '_histogramdd_from_bin_cts', '_histogramdd_from_bin_tensors', '_index_put_impl_', '_indices_copy',
 ...
 '_logcumsumexp', '_lstm_mps', '_lu_with_info', '_lu_with_info', '_make_dual', '_make_dual_copy',
 '_make_per_channel_quantized_tensor', '_make_per_tensor_quantized_tensor', '_masked_scale',
 '_masked_softmax', '_mkldnn_reshape', '_mkldnn_transpose', '_mkldnn_transpose_',
 '_mps_convolution', '_mps_convolution_transpose', '_mps_max_pool2d', '_native_batch_norm_legit',
 ...
 '_scaled_dot_product_flash_attention', '_shape_as_tensor', '_sobol_engine_draw',
 '_sobol_engine_ff_', '_sobol_engine_initialize_state_', '_sobol_engine_scramble_', '_softmax',
 '_softmax_backward_data', '_sparse_broadcast_to', '_sparse_broadcast_to_copy',
 '_sparse_bsc_tensor_unsafe', '_sparse_bsr_tensor_unsafe', '_sparse_compressed_tensor_unsafe',
 '_sparse_coo_tensor_unsafe', '_sparse_csc_tensor_unsafe', '_sparse_csr_prod', '_sparse_csr_sum',
 '_sparse_csr_tensor_unsafe', '_sparse_log_softmax_backward_data', '_sparse_mask_helper',
 ...
 '_test_serialization_subcmul', '_to_cpu', '_to_functional_tensor', '_transform_bias_rescale_qkv',
 ...
 'mkldnn_max_pool2d', 'mkldnn_max_pool3d', 'mm', 'mode', 'mode', 'moveaxis', 'movedim', 'msort',
 'mul', 'multinomial', 'multiply', 'mv', 'mvlgamma', 'nan_to_num', 'nan_to_num_', 'nanmean',
 'nanmedian', 'nanmedian', 'nanquantile', 'nansum', 'narrow', 'narrow_copy', 'native_batch_norm',
 'native_channel_shuffle', 'native_dropout', 'native_group_norm', 'native_layer_norm',
 ...
 'ormqr', 'outer', 'pairwise_distance', 'pdist', 'permute', 'permute_copy', 'pinverse',
 'pixel_shuffle', 'pixel_unshuffle', 'poisson', 'poisson_nll_loss', 'polar', 'polygamma',
 'positive', 'pow', 'prelu', 'prod', 'promote_types', 'put', 'q_per_channel_axis',
 'q_per_channel_scales', 'q_per_channel_zero_points', 'q_scale', 'q_zero_point', 'qr', 'qr',
 'quantile', 'quantize_per_channel', 'quantize_per_tensor', 'quantize_per_tensor_dynamic',
 ...
 'repeat_interleave', 'reshape', 'resize_as_', 'resize_as_sparse_', 'resolve_conj', 'resolve_neg',
 'result_type', 'rnn_relu', 'rnn_relu_cell', 'rnn_tanh', 'rnn_tanh_cell', 'roll', 'rot90', 'round',
 'round_', 'row_indices_copy', 'row_stack', 'rrelu', 'rrelu_', 'rsqrt', 'rsqrt_', 'rsub', 'saddmm',
 'scalar_tensor', 'scatter', 'scatter_add', 'scatter_reduce', 'searchsorted', 'segment_reduce',
 'select', 'select_copy', 'select_scatter', 'selu', 'selu_', 'set_flush_denormal',
 'set_num_interop_threads', 'set_num_threads', 'sgn', 'sigmoid', 'sigmoid_', 'sign', 'signbit',
 'sin', 'sin_', 'sinc', 'sinc_', 'sinh', 'sinh_', 'slice_copy', 'slice_scatter', 'slogdet',
 'slogdet', 'smm', 'softmax', 'sort', 'sort', 'sparse_bsc_tensor', 'sparse_bsr_tensor',
 'sparse_compressed_tensor', 'sparse_coo_tensor', 'sparse_csc_tensor', 'sparse_csr_tensor',
 'split_copy', 'split_with_sizes', 'split_with_sizes_copy', 'spmm', 'sqrt', 'sqrt_', 'square',
 'square_', 'squeeze', 'squeeze_copy', 'sspaddmm', 'stack', 'std', 'std_mean', 'sub', 'subtract',
 'sum', 'svd', 'svd', 'swapaxes', 'swapdims', 'symeig', 'symeig', 't', 't_copy', 'take',
