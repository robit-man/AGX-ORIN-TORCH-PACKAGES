...
class TORCH_API Tensor: public TensorBase {
 ...
 public:
  ...
  at::Tensor to_sparse(c10::optional<at::Layout> layout=c10::nullopt, at::OptionalIntArrayRef blocksize=c10::nullopt) const;
...
// aten::to_sparse(Tensor self, *, Layout? layout=None, int[2]? blocksize=None) -> Tensor
inline at::Tensor Tensor::to_sparse(c10::optional<at::Layout> layout, at::OptionalIntArrayRef blocksize) const {
    return at::_ops::to_sparse::call(const_cast<Tensor&>(*this), layout, blocksize);
}
